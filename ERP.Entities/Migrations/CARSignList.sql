...
SELECT        CARCartables.FieldCode, CARCartables.RequestDate, CARCartableTraces_NewLevel.CARTableId, CARCartableTraces_NewLevel.SignTitle, CARCartableTraces_NewLevel.SignTitleFa, CARTables.TableName, AdminForms.FormName, AdminForms.FormNameFa
